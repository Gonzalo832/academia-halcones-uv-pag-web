...
import IndexAdmin from './Roles/admin/indexadmin';

function App() {
  const [menuOpen, setMenuOpen] = useState(false);
  const location = useLocation();
  const showHeaderFooter = location.pathname !== '/login' && !location.pathname.startsWith('/admin');
    ...
    <>
      ...
      <main>
        <Routes>
          ...
          <Route path="/admin/inicio" element={<IndexAdmin />} />
          
          {/* (Aquí añadirás tus otras rutas de admin en el futuro) */}
          {/* <Route path="/admin/gestion-alumnos" element={<GestionAlumnos />} /> */}
          {/* <Route path="/admin/gestion-padres" element={<GestionPadres />} /> */}

        </Routes>
      </main>

      {/* 6. APLICA LA CONDICIÓN AL FOOTER */}
      {showHeaderFooter && (
